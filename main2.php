...
class others
{
    ...
    public static $paizu_jc = array(
        array('id' => 1, 'class'=>'jc','name' => 'neiqiemei','url'=>'pic\/eJ\/neiqiemei.jpg'),
        array('id' => 2, 'class'=>'jc','name' => 'DNAlianjiemei','url'=>'pic\/eJ\/DNAlianjiemei.jpg'),
        array('id' => 3, 'class'=>'jc','name' => 'gujiazaiti','url'=>'pic\/eJ\/gujiazaiti.jpg'),
        array('id' => 4, 'class'=>'jc','name' => 'mudijiyin','url'=>'pic\/eJ\/mudijiyin.jpg'),
        array('id' => 5, 'class'=>'jc','name' => 'xijun','url'=>'pic\/eJ\/xijun.jpg'),
        array('id' => 6, 'class'=>'jc','name' => 'PCR','url'=>'pic\/eJ\/PCR.jpg'),
    );
    public  static $paizu_gn = array(
        array('id' => 7, 'class'=>'gn','name' => 'shijunti','url'=>'pic/eG/shijunti.jpg'),
        array('id' => 8,  'class'=>'gn','name' => 'kangshengsu','url'=>'pic/eG/kangshengsu.jpg'),
        array('id' => 9,  'class'=>'gn','name' => 'kangxingjiyin','url'=>'pic/eG/kangxingjiyin.jpg'),
        array('id' => 10, 'class'=>'gn','name' => 'gaowen','url'=>'pic/eG/gaowen.jpg'),
        array('id' => 11, 'class'=>'gn','name' => 'hesuanshuijiemei','url'=>'pic/eG/hesuanshuijiemei.jpg'),
        array('id' => 12, 'class'=>'gn','name' => 'ziwaixian','url'=>'pic/eG/ziwaixian.jpg'),
        array('id' => 13, 'class'=>'gn','name' => 'zhuanyi','url'=>'pic/eG/zhuanyi.jpg'),
    );
